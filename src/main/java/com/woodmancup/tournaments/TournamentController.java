...
public class TournamentController {
	...
	@ResponseBody
	public List<WoodmanCupEvent> listTournaments() {
	...
	@ResponseBody
	public WoodmanCupEvent getTournament(@PathVariable String id) {
		WoodmanCupEvent tournament = tournamentRepository.findById(id);
